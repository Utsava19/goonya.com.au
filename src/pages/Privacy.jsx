      ...
      <section className="section-fade-to-surface page-section">
        <div className="page-container" style={{ maxWidth: 800, paddingBottom: 80 }}>
          <div style={{ color: "#5c5868", fontSize: "15px", lineHeight: 1.8 }}>
            ...
            <h2 style={{ color: "#141118", fontSize: "18px", margin: "32px 0 12px" }}>Information we collect</h2>
            ...
            <h2 style={{ color: "#141118", fontSize: "18px", margin: "32px 0 12px" }}>How we use information</h2>
            <p style={{ marginBottom: "16px" }}>
            ...
            <h2 style={{ color: "#141118", fontSize: "18px", margin: "32px 0 12px" }}>Storage & security</h2>
            <p style={{ marginBottom: "16px" }}>
            ...
            <h2 style={{ color: "#141118", fontSize: "18px", margin: "32px 0 12px" }}>Your rights</h2>
            <p style={{ marginBottom: "16px" }}>
            ...
            <h2 style={{ color: "#141118", fontSize: "18px", margin: "32px 0 12px" }}>Contact</h2>
            <p>
